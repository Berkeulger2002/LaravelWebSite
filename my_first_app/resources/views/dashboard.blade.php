...
<body>
        ...
        <div class="row">
          <div class="col-sm-12 position-relative">
            <div class="about-img-box">
              <img src="assetsss/img/slide-about-1.jpg" alt="" class="img-fluid">
            </div>
            <div class="sinse-box">
          ...
          <div class="col-md-12 section-t8 position-relative">
            <div class="row">
              <div class="col-md-6 col-lg-5">
                <img src="assetsss/img/about-2.jpg" alt="" class="img-fluid">
              </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="assetsss/img/agent-7.jpg" alt="" class="img-d img-fluid">
              </div>
          ...
          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="assetsss/img/agent-6.jpg" alt="" class="img-d img-fluid">
              </div>
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
          ...
          <div class="col-md-4">
            <div class="card-box-d">
              <div class="card-img-d">
                <img src="assetsss/img/agent-5.jpg" alt="" class="img-d img-fluid">
              </div>
              <div class="card-overlay card-overlay-hover">
                <div class="card-header-d">
                  <div class="card-title-d align-self-center">
  ...
  <script src="assetsss/vendor/swiper/swiper-bundle.min.js"></script>
  <script src="assetsss/vendor/php-email-form/validate.js"></script>
